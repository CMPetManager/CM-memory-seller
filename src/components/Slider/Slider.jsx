      ...
      >
        <div className='slider__section' data-scroll-section ref={scrollRef}>
          <div className='scroll-content scroll-horizontal'>
            <div
              className='slider__section_photo-1 item'
              data-scroll
              data-scroll-speed='1'
            >
            ...
            <div
              className='slider__section_photo-2 item'
              data-scroll
            ...
            <div
              className='slider__section_photo-3 item'
              data-scroll
              data-scroll-speed='2'
            >
            ...
            <div
              className='slider__section_photo-4 item'
              data-scroll
              data-scroll-speed='3'
            >
            ...
            <div
              className='slider__section_photo-5 item'
              data-scroll
            ...
            <div
              className='slider__section_photo-6 item'
              data-scroll
              data-scroll-speed='1.5'
            >
            ...
            <div
              className='slider__section_photo-7 item'
              data-scroll
              data-scroll-speed='2'
            >
            ...
            <div
              className='slider__section_photo-8 item'
              data-scroll
              data-scroll-speed='2'
            >
            ...
            <div
              className='slider__section_photo-9 item'
              data-scroll
              data-scroll-speed='1.5'
            >
            ...
            <div
              className='slider__section_photo-10 item'
              data-scroll
              data-scroll-speed='3'
            >
            ...
            <div
              className='slider__section_photo-11 item'
              data-scroll
              data-scroll-speed='1.5'
            >
              <img
            ...
            <div
              className='slider__section_photo-12 item'
              data-scroll
            ...
            <div
              className='slider__section_photo-13 item'
              data-scroll
              data-scroll-speed='3'
            >
            ...
            <div
              className='slider__section_photo-14 item'
              data-scroll
              data-scroll-speed='1'
            >
            ...
            <div
              className='slider__section_photo-15 item'
              data-scroll
              data-scroll-speed='2'
            >
              <img
